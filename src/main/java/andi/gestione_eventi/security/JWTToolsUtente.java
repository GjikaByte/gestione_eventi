package andi.gestione_eventi.security;
...
public class JWTToolsUtente {
    ...
    public String generateToken(Utente utente) {
        return Jwts.builder()
                ...
                .subject(String.valueOf(utente.getId_utente())) // Subject cioè a chi appartiene il token. Ci inseriamo l'id dell'utente (MAI METTERE DATI SENSIBILI AL SUO INTERNO)
